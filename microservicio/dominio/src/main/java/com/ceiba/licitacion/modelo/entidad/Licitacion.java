...
public class Licitacion {
    ...
    private static final String SE_DEBE_INGRESAR_EL_CODIGO = "Se debe ingresar el código de la Licitación";
    private static final String SE_DEBE_INGRESAR_EL_NOMBRE = "Se debe ingresar el nombre de la Licitación";
    private static final String SE_DEBE_INGRESAR_LA_DESCRIPCION = "Se debe ingresar la descripción de la Licitación";
    private static final String SE_DEBE_INGRESAR_EL_PRESUPUESTO = "Se debe ingresar el presupuesto de la Licitación";
    private static final String SE_DEBE_INGRESAR_LA_FECHA_INICIAL = "Se debe ingresar la fecha inicial de la Licitación";
    private static final String SE_DEBE_INGRESAR_LA_FECHA_FINAL = "Se debe ingresar la fecha final de la Licitación";
    private static final String SE_DEBE_INGRESAR_EL_ESTADO = "Se debe ingresar el estado de la Licitación";
    
    private static final String CODIGO_DEBE_TENER_UNA_LONGITUD_MENOR_O_IGUAL_A = "El código debe tener una longitud menor o igual a %s";
