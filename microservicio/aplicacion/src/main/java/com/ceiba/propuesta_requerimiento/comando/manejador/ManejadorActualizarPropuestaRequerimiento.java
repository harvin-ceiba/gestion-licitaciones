...
@Component
public class ManejadorActualizarPropuestaRequerimiento implements ManejadorComando<ComandoLicitacionRequerimiento> {
    ...
    public ManejadorActualizarPropuestaRequerimiento(
